<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit highlight-current-row>
      ...
      <el-table-column label="操作" align="center" prop="" width="300">
        <template scope="scope">
          <el-button class="filter-item" size="mini" @click="addMember(scope.row)" type="info" icon="">新增会员</el-button>
          ...
          <el-button class="filter-item" size="mini" @click="setLimit(scope.row)" type="info" icon="">设置限额</el-button>
